                          ...
                          <div class="post_info flex_space_between created_post">
                            ...
                            <div class="flex"> 
                              ...
                              <div class="comment_icon_wrap">
                                ...
                                <a onclick="return checkDelete2()" class="delete-comment" data-remote="true" rel="nofollow" data-method="delete" href="/comments/{{ $comment->id }}"><i class="fa-solid fa-trash-can"></i></a>
                                @else
                                <a class="delete-comment" data-remote="true" rel="nofollow" data-method="delete" href=""><i class="fa-solid fa-ban"></i></a><!--通報についてのリンクを春-->
                                @endif
